...
try {
  isDomReady()
    ...
    .then(() => {
      ...
      const navbar_toggle_button = document.getElementById("navbar-toggle-button");
      const navbar_menu_close_button = document.getElementById("navbar-menu-close-button");
      ...
      const navbar_menu_links = document.querySelectorAll("#main-navbar .navbar-menu-link");
