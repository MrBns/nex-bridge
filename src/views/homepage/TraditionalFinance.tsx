...
function TraditionalFinance({}: Props) {
  return (
    <div className="my-container mx-5 lg:mx-auto flex flex-col lg:flex-row justify-between gap-10 mt-10 lg:mt-20 text-white relative">
      <div className="w-full pt-36 sm:pt-40 xl:w-[75%] p-10 rounded-[25px] lg:rounded-[50px] flex flex-col lg:pt-10 lg:pb-16 lg:pl-24 lg:pr-28 bg-[url('/ready-to-take-bg.svg')] bg-cover bg-no-repeat bg-bottom">
