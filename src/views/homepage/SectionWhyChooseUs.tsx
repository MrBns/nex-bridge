            ...
            {WHY_CHOOSE_US_CARD_DATA.map((d, idx) => (
              ...
              >
                <Img
                  src={d.img}
                  alt={d.title}
                className="me-4 lg:mb-8  lg:me-0 w-[70px] lg:w-auto lg:h-[100px] lg:opacity-60 group-hover:opacity-100 transition-all duration-500 group-hover:scale-110 group-hover:rotate-[20deg]"
                />
                <div className="">
