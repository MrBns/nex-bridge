        ...
        <section className="w-[60%]">
          ...
          <div className="grid grid-cols-4 w-max gap-4">
            <button className="px-3 py-2 rounded-lg bg-[#144064] border border-[#144064]">
              <span className="text-white text-[22px]/[28px] font-semibold">
                1
              </span>
            </button>
            <button className="px-3 py-2 rounded-lg bg-[#000000] border border-[#144064]">
              <span className="text-[#ABABAB] text-[22px]/[28px] font-semibold">
                2
              </span>
            </button>
            <button className="px-3 py-2 rounded-lg bg-[#000000] border border-[#144064]">
  ...
  return (
    <div className="w-full rounded-[17px] overflow-hidden">
      <div className="bg-[#D9D9D9] h-[300px] flex items-end">
        ...
        <div className="px-8 py-5 flex items-center gap-3">
          {props.tags.map((tag) => (
            <p
              key={tag}
              className="uppercase bg-white px-4 py-2 text-black text-[11px]/[18px] font-semibold rounded-lg"
            >
              {tag}
            </p>
          ))}
      ...
      <div className="bg-[#092B46] px-8 py-7">
        <h2 className="font-semibold text-[22px]/[28px]">{props.title}</h2>
        <p className="font-light text-[14px]/[21px] opacity-80 mt-4">
        ...
        <div className="mt-5 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="text-[11px]/[18px]">
              ...
              <p className="opacity-80">{props.publishedDate}</p>
            </div>
          </div>
