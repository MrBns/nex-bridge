...
export type BlogType = BlogSliderResponse;

async function SectionBlogs({}: Props) {
  const data: BlogSliderResponse = await (
    await fetch("https://admin.nexbridge.ch/api/homepage-blog-slider?populate[blogs][populate][0]=categories")
  ).json();
    ...
    <div className="w-full pt-20 xl:pb-28 2xl:pb-40">
      ...
      <div data-aos className="my-container mx-5 lg:mx-auto mt-5">
        ...
        <p className="text-center mt-5 lg:mt-16 max-w-[896px] mx-auto text-[12px] leading-[15px] md:text-[16px] md:leading-[19px] lg:text-[20px] lg:leading-[30px]">
          Stay up to date with the latest trends and insights in technology with our informative blog. From industry news to expert tips, we&apos;ve
          got you covered.
        </p>
      </div>
